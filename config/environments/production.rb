...
Rails.application.configure do
  ...
  config.action_mailer.default_url_options = {host: "https://recipe-app-nr65.onrender.com/", protocol: "https"}
  ...
  config.action_mailer.smtp_settings = {
    ...
    password: 'smxoxklouinylitv', # Replace with your Gmail password
